...
```
![Sample panel plot](instructions_fig/total_steps.png)
...
```
![Sample panel plot](instructions_fig/steps(NA_removed).png)
...
```     
![Sample panel plot](instructions_fig/total_steps_per_day(NA_removed).png)
...
print(s)
```
![Sample panel plot](instructions_fig/weekday_vs_weekend.png)
